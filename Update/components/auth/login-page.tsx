...
export function LoginPage({ onContinue, onBack, onSwitchToSignup }: LoginPageProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl px-4 py-3 transition-all focus:outline-none"
              style={{
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl px-4 py-3 pr-12 transition-all focus:outline-none"
                style={{
                  background: "rgba(255, 255, 255, 0.7)",
                  backdropFilter: "blur(20px)",
                  WebkitBackdropFilter: "blur(20px)",
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="flex items-center justify-center gap-2 rounded-2xl py-3 text-sm font-medium transition-all hover:opacity-80"
              style={{
                background: "rgba(255, 255, 255, 0.7)",
                backdropFilter: "blur(20px)",
                WebkitBackdropFilter: "blur(20px)",
